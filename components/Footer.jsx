          ...
          <div>
            ...
            <ul className="space-y-4">
              <motion.li
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <Phone className="h-5 w-5 text-[#656839] mt-0.5 flex-shrink-0" />
              ...
              <motion.li
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <Mail className="h-5 w-5 text-[#656839] mt-0.5 flex-shrink-0" />
              ...
              <motion.li
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <MapPin className="h-5 w-5 text-[#656839] mt-0.5 flex-shrink-0" />
