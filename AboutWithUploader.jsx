...
function AboutWithUploader() {
  const aboutRef = useRef(null)
  const isAboutInView = useInView(aboutRef, { once: true, amount: 0.3 })
  const [aboutImage, setAboutImage] = useState("/placeholder.svg?height=500&width=600")
  ...
  return (
    <section id="about" className="py-20 bg-amber-50" ref={aboutRef}>
      <div className="container mx-auto px-4">
        ...
        {/* Uploader para cambiar la imagen */}
...
export default AboutWithUploader
